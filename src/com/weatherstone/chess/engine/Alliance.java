...
public enum Alliance {
	...
	WHITE {
		...
		public int pawnBonus(int position) {
			return WHITE_PAWN_PREFFERRED_COORDINATES[position];
		}
...

	{
		...
		@Override
		public int pawnBonus(int position) {
			return BLACK_PAWN_PREFFERRED_COORDINATES[position];
		}
	...
	private static final int[] WHITE_PAWN_PREFFERRED_COORDINATES = {
			0,	0,	0,	0,	0,	0,	0,	0,
	...
	private static final int[] BLACK_PAWN_PREFFERRED_COORDINATES = {
			0,	0,	0,	0,	0,	0,	0,	0,
			5,	10,	10,	-20,-20,10,	10,	5,	
			5,	-5,	-10,0,	0,	-10,-5,	5, 
			0,	0,	0,	20,	20,	0,	0,	0,
