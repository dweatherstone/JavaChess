...
public class AlphaBetaPruning extends Observable implements MoveStrategy {
	...
	private int calculateQuiescenceDepth(final Board board, final int depth) {
	...
	private static String score(final Player currentPlayer,
		...
		throw new RuntimeException("Current player isn't black or white!!");
	}
