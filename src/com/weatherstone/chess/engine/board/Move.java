...
public abstract class Move {
	...
	public static final class PawnEnPassantAttackMove extends PawnAttackMove {
		...
		public PawnEnPassantAttackMove(final Board board, final Piece movedPiece, final int destinationCoordinates,
	...
	public static class PawnAttackMove extends AttackMove {
		...
		public PawnAttackMove(final Board board, final Piece movedPiece, final int destinationCoordinates,
				final Piece attackedPiece) {
			super(board, movedPiece, destinationCoordinates, attackedPiece);
	...
	public static class AttackMove extends Move {
		...
		public AttackMove(final Board board, final Piece movedPiece, final int destinationCoordinates,
				final Piece attackedPiece) {
			super(board, movedPiece, destinationCoordinates);
