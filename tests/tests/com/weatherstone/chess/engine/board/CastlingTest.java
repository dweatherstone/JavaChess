...
class CastlingTest {
	...
	void testWhiteKingSideCastle() {
		...
		final MoveTransition t3 = t2.getToBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t2.getToBoard(),
				BoardUtils.INSTANCE.getCoordinateAtPosition("g1"), BoardUtils.INSTANCE.getCoordinateAtPosition("f3")));
		assertTrue(t3.getMoveStatus().isDone());
		final MoveTransition t4 = t3.getToBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t3.getToBoard(),
				BoardUtils.INSTANCE.getCoordinateAtPosition("d7"), BoardUtils.INSTANCE.getCoordinateAtPosition("d6")));
		assertTrue(t4.getMoveStatus().isDone());
		final MoveTransition t5 = t4.getToBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t4.getToBoard(),
				BoardUtils.INSTANCE.getCoordinateAtPosition("f1"), BoardUtils.INSTANCE.getCoordinateAtPosition("e2")));
		assertTrue(t5.getMoveStatus().isDone());
		final MoveTransition t6 = t5.getToBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t5.getToBoard(),
				BoardUtils.INSTANCE.getCoordinateAtPosition("d6"), BoardUtils.INSTANCE.getCoordinateAtPosition("d5")));
		assertTrue(t6.getMoveStatus().isDone());

		final Move wm1 = Move.MoveFactory.createMove(t6.getToBoard(), BoardUtils.INSTANCE.getCoordinateAtPosition("e1"),
				BoardUtils.INSTANCE.getCoordinateAtPosition("g1"));
	...
	void testWhiteQueenSideCastle() {
		...
		assertTrue(t2.getMoveStatus().isDone());
		final MoveTransition t3 = t2.getToBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t2.getToBoard(),
				BoardUtils.INSTANCE.getCoordinateAtPosition("d2"), BoardUtils.INSTANCE.getCoordinateAtPosition("d3")));
		assertTrue(t3.getMoveStatus().isDone());
		final MoveTransition t4 = t3.getToBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t3.getToBoard(),
				BoardUtils.INSTANCE.getCoordinateAtPosition("d7"), BoardUtils.INSTANCE.getCoordinateAtPosition("d6")));
		assertTrue(t4.getMoveStatus().isDone());
		final MoveTransition t5 = t4.getToBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t4.getToBoard(),
				BoardUtils.INSTANCE.getCoordinateAtPosition("c1"), BoardUtils.INSTANCE.getCoordinateAtPosition("d2")));
		assertTrue(t5.getMoveStatus().isDone());
		final MoveTransition t6 = t5.getToBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t5.getToBoard(),
				BoardUtils.INSTANCE.getCoordinateAtPosition("d6"), BoardUtils.INSTANCE.getCoordinateAtPosition("d5")));
		assertTrue(t6.getMoveStatus().isDone());
		final MoveTransition t7 = t6.getToBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t6.getToBoard(),
				BoardUtils.INSTANCE.getCoordinateAtPosition("d1"), BoardUtils.INSTANCE.getCoordinateAtPosition("e2")));
		assertTrue(t7.getMoveStatus().isDone());
		final MoveTransition t8 = t7.getToBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t7.getToBoard(),
				BoardUtils.INSTANCE.getCoordinateAtPosition("h7"), BoardUtils.INSTANCE.getCoordinateAtPosition("h6")));
		assertTrue(t8.getMoveStatus().isDone());
		final MoveTransition t9 = t8.getToBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t8.getToBoard(),
		...
		final MoveTransition t10 = t9.getToBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t9.getToBoard(),
				BoardUtils.INSTANCE.getCoordinateAtPosition("h6"), BoardUtils.INSTANCE.getCoordinateAtPosition("h5")));
		assertTrue(t10.getMoveStatus().isDone());

		final Move wm1 = Move.MoveFactory.createMove(t10.getToBoard(),
				BoardUtils.INSTANCE.getCoordinateAtPosition("e1"), BoardUtils.INSTANCE.getCoordinateAtPosition("c1"));
	...
	void testBlackKingSideCastle() {
		...
		assertTrue(t4.getMoveStatus().isDone());
		final MoveTransition t5 = t4.getToBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t4.getToBoard(),
				BoardUtils.INSTANCE.getCoordinateAtPosition("d3"), BoardUtils.INSTANCE.getCoordinateAtPosition("d4")));
		assertTrue(t5.getMoveStatus().isDone());
		final MoveTransition t6 = t5.getToBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t5.getToBoard(),
				BoardUtils.INSTANCE.getCoordinateAtPosition("f8"), BoardUtils.INSTANCE.getCoordinateAtPosition("e7")));
		assertTrue(t6.getMoveStatus().isDone());
		final MoveTransition t7 = t6.getToBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t6.getToBoard(),
				BoardUtils.INSTANCE.getCoordinateAtPosition("d4"), BoardUtils.INSTANCE.getCoordinateAtPosition("d5")));
		assertTrue(t7.getMoveStatus().isDone());

		final Move wm1 = Move.MoveFactory.createMove(t7.getToBoard(), BoardUtils.INSTANCE.getCoordinateAtPosition("e8"),
				BoardUtils.INSTANCE.getCoordinateAtPosition("g8"));
	...
	public void testBlackQueenSideCastle() {
		...
		assertTrue(t9.getMoveStatus().isDone());
		final MoveTransition t10 = t9.getToBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t9.getToBoard(),
				BoardUtils.INSTANCE.getCoordinateAtPosition("c8"), BoardUtils.INSTANCE.getCoordinateAtPosition("d7")));
		assertTrue(t10.getMoveStatus().isDone());
		...
		final Move wm1 = Move.MoveFactory.createMove(t11.getToBoard(),
				BoardUtils.INSTANCE.getCoordinateAtPosition("e8"), BoardUtils.INSTANCE.getCoordinateAtPosition("c8"));
	 ...
	 *       board.currentPlayer().makeMove(Move.MoveFactory.createMove(board,
	 *       BoardUtils.INSTANCE.getCoordinateAtPosition("e2"),
	 *       BoardUtils.INSTANCE.getCoordinateAtPosition("e4")));
	 *       assertTrue(t1.getMoveStatus().isDone()); final MoveTransition t2 =
	 *       t1.getTransitionBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t1.getTransitionBoard(),
	 *       BoardUtils.INSTANCE.getCoordinateAtPosition("d7"),
	 *       BoardUtils.INSTANCE.getCoordinateAtPosition("d5")));
	 *       assertTrue(t2.getMoveStatus().isDone()); final MoveTransition t3 =
	 *       t2.getTransitionBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t2.getTransitionBoard(),
	 *       BoardUtils.INSTANCE.getCoordinateAtPosition("e4"),
	 *       BoardUtils.INSTANCE.getCoordinateAtPosition("e5")));
	 *       assertTrue(t3.getMoveStatus().isDone()); final MoveTransition t4 =
	 *       t3.getTransitionBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t3.getTransitionBoard(),
	 *       BoardUtils.INSTANCE.getCoordinateAtPosition("c8"),
	 *       BoardUtils.INSTANCE.getCoordinateAtPosition("f5")));
	 *       assertTrue(t4.getMoveStatus().isDone()); final MoveTransition t5 =
	 *       t4.getTransitionBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t4.getTransitionBoard(),
	 *       BoardUtils.INSTANCE.getCoordinateAtPosition("f1"),
	 *       BoardUtils.INSTANCE.getCoordinateAtPosition("d3")));
	 *       assertTrue(t5.getMoveStatus().isDone()); final MoveTransition t6 =
	 *       t5.getTransitionBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t5.getTransitionBoard(),
	 *       BoardUtils.INSTANCE.getCoordinateAtPosition("f5"),
	 *       BoardUtils.INSTANCE.getCoordinateAtPosition("d3")));
	 *       assertTrue(t6.getMoveStatus().isDone()); final MoveTransition t7 =
	 *       t6.getTransitionBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t6.getTransitionBoard(),
	 *       BoardUtils.INSTANCE.getCoordinateAtPosition("c2"),
	 *       BoardUtils.INSTANCE.getCoordinateAtPosition("d3")));
	 *       assertTrue(t7.getMoveStatus().isDone()); final MoveTransition t8 =
	 *       t7.getTransitionBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t7.getTransitionBoard(),
	 *       BoardUtils.INSTANCE.getCoordinateAtPosition("e7"),
	 *       BoardUtils.INSTANCE.getCoordinateAtPosition("e6")));
	 *       assertTrue(t8.getMoveStatus().isDone()); final MoveTransition t9 =
	 *       t8.getTransitionBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t8.getTransitionBoard(),
	 *       BoardUtils.INSTANCE.getCoordinateAtPosition("d1"),
	 *       BoardUtils.INSTANCE.getCoordinateAtPosition("a4")));
	 *       assertTrue(t9.getMoveStatus().isDone()); final MoveTransition t10 =
	 *       t9.getTransitionBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t9.getTransitionBoard(),
	 *       BoardUtils.INSTANCE.getCoordinateAtPosition("d8"),
	 *       BoardUtils.INSTANCE.getCoordinateAtPosition("d7")));
	 *       assertTrue(t10.getMoveStatus().isDone()); final MoveTransition t11 =
	 *       t10.getTransitionBoard().currentPlayer().makeMove(Move.MoveFactory.createMove(t10.getTransitionBoard(),
